...
class _HomePageState extends State<HomePage> {
  ...
  List mostCountryAffectedDataResponse;
  ...
  fetchCountryData() async {
    ...
    setState(() {
      mostCountryAffectedDataResponse = jsonDecode(response2.body);
    });
  }
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    mostCountryAffectedDataResponse == null
                        ? Center(child: CupertinoActivityIndicator())
                        : MostAffectedPanel(
                            countryData: mostCountryAffectedDataResponse,
                          ),
                    mediumVerticalGap,
                    InfoPanel(),
                  ],
